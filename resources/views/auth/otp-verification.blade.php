...
<body>
    ...
    <div class="login container grid" id="loginAccessRegister">
        ...
        <div class="login__access">
            <h1 class="login__title">Enter OTP Code.</h1>

            <div class="login__area">
                <form action="{{ route('otp.verify') }}" class="login__form" method="POST">
                    @csrf
                    <div class="login__content grid">
                        <div class="login__box">
                            <input type="text" id="otp" required placeholder=" " class="login__input"
                                name="otp">
                            <label for="otp" class="login__label">Otp Code</label>

                            <i class="ri-verified-badge-fill login__icon"></i>
                        </div>

                    </div>

                    <button type="submit" class="login__button">Login</button>
                    {{-- <a href="{{ route('dashboard') }}" class="login__button">Login</a> --}}
                </form>
                ...
                <p class="login__switch">
                    ...
                    <button id="loginButtonRegister">Resend</button>
                </p>
            </div>
        </div>
