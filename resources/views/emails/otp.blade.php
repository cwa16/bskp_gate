                                    ...
                                    {{-- <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                NIK: {{ $data['nik'] }}<br><br>
                                                Your registered email: {{ $data['email'] }}<br><br>
                                                Thank you for verifying your login. Use the OTP code below to access
                                                your account:<br><br>
                                            </div>
                                        </td>
                                    </tr> --}}
                                    ...
                                    <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                ...
                                                The OTP code is valid until <b>{{ $data['otp_valid_until'] }}
                                                    WITA.</b><br><br>
                                                Best regards,<br> IT Dept<br>PT. Bridgestone Kalimantan Plantation<br>
                                            </div>
                                        </td>
                                    </tr>
