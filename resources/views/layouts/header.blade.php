        ...
        <div class="main-header-logo">
            ...
            <div class="logo-header" data-background-color="dark">
                <a href="index.html" class="logo">
                    <img src="{{ asset('assets/img/kaiadmin/Proyek_Baru.png') }}" alt="navbar brand" class="navbar-brand"
                        height="20" />
                </a>
        ...
        <nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg border-bottom">
            <div class="container-fluid">
                <nav class="navbar navbar-header-left navbar-expand-lg navbar-form nav-search p-0 d-none d-lg-flex">
                    ...
                    {{-- <h6 class="op-7 mb-2">Selamat Datang di BSKP GATE</h6> --}}
                </nav>
                ...
                <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                    ...
                    <li class="nav-item topbar-user dropdown hidden-caret">
                        <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                            aria-expanded="false">
                            <div class="avatar-sm">
                                <img src="{{ asset('assets/img/kaiadmin/favicon.png') }}" alt="..."
                                            ...
                                            @if (Auth::check())
                                                <form action="{{ route('logout') }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="nik"
                                                        value="{{ Auth::user()->nik }}">
                                                    <button type="submit"
                                                        class="btn btn-xs btn-secondary btn-sm">Logout</button>
                                                </form>
                                            @else
                                                <script>
